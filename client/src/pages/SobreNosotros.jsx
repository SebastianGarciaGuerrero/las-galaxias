...
const SobreNosotros = () => {
    ...
    return (
        ...
        <div className="w-full animate-fade-in pb-20">
            ...
            {/* El padding de arriba deja pasar el navbar, que es fixed y mide
                64px. Con py-16 la esquina de la foto, que sobresale de su caja
                por el rotate-2, quedaba justo debajo de la barra. */}
            <div className="w-full max-w-[1280px] mx-auto px-4 pt-28 md:pt-32 pb-16">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    {/* La foto es vertical (900x1200). En una caja apaisada el
                        object-cover centrado partía el mural al medio y llenaba
                        la mitad de abajo con la terraza. Caja más alta y recorte
                        subido al 15% para que entre entero el perro con la
                        pelota y el "Las Galaxias FC". */}
                    <div className="relative h-[440px] md:h-[560px] lg:h-[620px] rounded-2xl overflow-hidden bg-slate-200 shadow-2xl rotate-2 hover:rotate-0 transition-all duration-500 group">
                        <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 to-black/40 z-10 group-hover:opacity-60 transition-opacity"></div>
                        <img
                            src="https://res.cloudinary.com/du4oddnjl/image/upload/q_auto,f_auto,w_1200/v1773720637/canchita_mzu8aa.jpg"
                            alt="Mural de Las Galaxias FC en Valparaíso"
